...
// const arrayAnimais = [];
const arrayAnimais = JSON.parse(localStorage.getItem("arrayAnimals")) || []
// const arrayAnimais = localStorage.getItem("arrayAnimals") ?? []
// const arrayAnimais = localStorage.getItem("arrayAnimals")?localStorage.getItem("arrayAnimals"):[] 
...
form.addEventListener('submit', (event) => {
  ...
  // localStorage é uma variavel global
